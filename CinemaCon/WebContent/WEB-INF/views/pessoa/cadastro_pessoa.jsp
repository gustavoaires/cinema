		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbar-ex-collapse">
				<ul class="nav navbar-nav navbar-right">
					<li class="active"><a href="#">Cadastrar Pessoa</a></li>
					...
					<form role="form" method="post" action="cadastroPessoaFormulario">
						...
						<div class="form-group">
							<label class="control-label">Sobrenome</label> <input
								...
								placeholder="Sobrenome" type="text" pattern="([a-zA-Z0-9]+[ ]?)*">
						</div>
						<div class="form-group">
							<label class="control-label">Data de nascimento</label> <input
								name="dataNascimento" class="form-control" required="required"
								pattern="[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" type="text"
